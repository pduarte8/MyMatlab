...
% depth_range = [-10000  99];  range_label = '95to105m';
...
% depth_range = [ -36 -32];  range_label = '32 to 36m';
depth_range = [ -170 -160];  range_label = '32 to 36m';
...
switch case_label
    ...
    case 'future'
        ...
        % Data file directory
        dir_data = '/tos-project3/NS9081K/NORSTORE_OSL_DISK/NS9081K/K160_bgc/Sim19/';
        % file list
        file_list = sprintf('files_%s_%s_%s.txt', sim_label,case_label,month);
    case 'surface'
        % Grid file
...
size(sbar)
% Map projection
%m_proj('lambert','long',[11.0 13.2],'lat',[78.7 79.2]);
