...
rdir = '/tos-project3/NS9081K/NORSTORE_OSL_DISK/NS9081K/K160_bgc/Sim19'
prename = 'ocean_avg_';
nfiles = 80;
%nfiles = 40;
...
FigureName = strcat('mean_curr_speed','_',MapFile,'_',num2str(aindex+1),'_',num2str(nfiles));
hgsave(FigureName);
%--------------------
...
FigureName = strcat('mean_temp','_',MapFile,'_',num2str(aindex+1),'_',num2str(nfiles));
hgsave(FigureName);
...
FigureName = strcat('mean_salt','_',MapFile,'_',num2str(aindex+1),'_',num2str(nfiles));
hgsave(FigureName);
...
FigureName = strcat('mean_no3','_',MapFile,'_',num2str(aindex+1),'_',num2str(nfiles));
hgsave(FigureName);
...
FigureName = strcat('mean_phyto','_',MapFile,'_',num2str(aindex+1),'_',num2str(nfiles));
hgsave(FigureName);
...
FigureName = strcat('volflux','_',MapFile,'_',num2str(aindex+1),'_',num2str(nfiles));
hgsave(FigureName);
