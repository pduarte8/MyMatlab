...
% Inner polygon between Blomstrand and the most inner ploygons of
% Kongsbreen and Kronebreen


lat_poly = [  78.930235  78.961542  78.994000  79.004000  79.051000 78.991655 78.971892 78.913930 78.879487  78.901000 78.930235];
lon_poly = [  11.917598  12.018469  12.015000  11.997000  12.277000 12.470520 12.466063 12.476839 12.405971  11.928000 11.917598];
...
% save mask
save('mask_KF_Blomstrand_present.mat', 'mask_fjord');
