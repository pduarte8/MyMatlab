...
% Inner polygon in front of Kronebreen


lat_poly = [  78.879487  78.913930  78.929000  78.844000   78.879487];
lon_poly = [  12.405971  12.476839  12.805000  12.469000   12.405971];
...
% save mask
save('mask_KF_Kronebreen_present.mat', 'mask_fjord');
