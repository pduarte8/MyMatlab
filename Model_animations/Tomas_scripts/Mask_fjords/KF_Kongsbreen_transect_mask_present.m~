...
lat_poly = [  78.971892  78.991655  79.014000  78.951000   78.971892];
lon_poly = [  12.466063  12.470520  12.608000  12.675000   12.466063];
...
% save mask
save('mask_KF_Kongsbreen_present.mat', 'mask_fjord');
