...
lat_poly = [  78.971892  78.991655  lat(212,1) lat(120,1) lat(110,50)  78.971892];
lon_poly = [  12.466063  12.470520  lon(212,1) lon(120,1) lon(110,50)  12.466063];
...
% save mask
save('mask_KF_Kongsbreen_future.mat', 'mask_fjord');
