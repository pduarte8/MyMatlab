...
% Load plume data
Zpp = csvread('Kronebreen_output\kronebreen_results_z.csv');
Tpp = csvread('Kronebreen_output\kronebreen_results_t_p.csv');
Spp = csvread('Kronebreen_output\kronebreen_results_s_p.csv');

load('Kronebreen_profile.mat');

load('Kronebreen_amb_profile.mat');
...
figure
p1 = gsw_SA_CT_plot(SA_KrB_amb,CT_KrB_amb);
p2 = gsw_SA_CT_plot(SA_KrB,CT_KrB);
set(p2,'Marker','o','MarkerSize',2,'MarkerFaceColor','r','MarkerEdgeColor','none');
p3 = gsw_SA_CT_plot(Spp,Tpp);
set(p3,'Marker','o','MarkerSize',2,'MarkerFaceColor','g','MarkerEdgeColor','none');
